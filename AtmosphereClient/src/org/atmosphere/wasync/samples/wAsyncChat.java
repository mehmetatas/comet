...
public class wAsyncChat {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args.length == 0) {
            args = new String[]{"http://vaio:8080/AtmosphereServer"};
        }
        ...
        socket.on(Event.MESSAGE.name(), new Function<Data>() {
            @Override
            public void on(Data t) {
                Date d = new Date(t.getTime());
                System.out.println(String.format("Author %s: %s", t.getAuthor() + "@ " + d.getHours() + ":" + d.getMinutes(), t.getMessage()));
            }
