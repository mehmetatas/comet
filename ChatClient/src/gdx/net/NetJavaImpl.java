...
import gdx.net.Net.HttpMethods;
import gdx.net.Net.HttpRequest;
import gdx.net.Net.HttpResponse;
import gdx.net.Net.HttpResponseListener;
...
public class NetJavaImpl {
        ...
        public void sendHttpRequest (final HttpRequest httpRequest, final HttpResponseListener httpResponseListener) {
                if (httpRequest.getUrl() == null) {
                        httpResponseListener.failed(new Exception("can't process a HTTP request without URL set"));
                        return;
                }
